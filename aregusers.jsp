...
//        String email=(String)session.getAttribute("Emailid");out.println(email);
	   ...
	   String s1="select FullName,MobileNo,Photo,Emailid from user" ;
	
     rs = stmt.executeQuery(s1);
      
		out.println("<body><h1 style='color:red'><div align=center><strong><span class=formhead>Registered Users</span></strong></div></h1></body>");
        ...
        while (rs.next())
        {
            out.println("<tr>");
                ...
                for(int x=1;x<=n;x++)
                {
        			...
        			out.println("<td><b><img src="+s3+" width=50 height=50></img></b></td>");
					 }
					  else
					  {
					                 out.println("<td><b>"+s+"</b></td>");
