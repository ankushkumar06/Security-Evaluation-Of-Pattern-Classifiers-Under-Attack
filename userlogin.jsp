...
-->							<!--<li><a href="portfolio.html">Portfolio</a></li>
		...
		<form name="form1" method="post" action="" >
          <table width="79%" border="0" cellpadding="10" cellspacing="10">
            <tr>
              <td colspan="3"><div align="center"><span class="formhead">User Login</span></div></td>
              <td width="28%" rowspan="5"><img src="images/signup.png" width="200" height="200" /></td>
            </tr>
            

            <tr>
              <td width="31%" height="59"><div align="right">Email Id</div></td>
              <td width="1%">&nbsp;</td>
            ...
            <tr>
              <td colspan="3"><p align="center" class="style3"><a href="usersignup.jsp"><strong><span class="style3 style1"><strong> No account?</strong></span> <span class="style1"><strong>Forgot Password ?</strong></span><br />
              </strong></a></p></td>
              </tr>
          </table>
      </form>
...
try
{
   ...
   String u=request.getParameter("textfield").trim();
	  ...
	  rs=stmt.executeQuery("select * from user where emailid="+"'"+u+"'"+" and pwd="+"'"+p+"'");
  ...
  String f="",a="",m="",e="",id="",status="";
	...
	status=rs.getString(6);
	 ...
	 if(found==1&& status.equals("ACTIVE"))
		 {
	...
	session.setAttribute("mobile",m);
		 ...
		 {
	out.println( "<script>alert('Login Unsuccess or Your Account may not be Active Please Check');window.location='userlogin.jsp';</script>");
